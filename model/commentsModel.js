...
class Comments {
  ...
  static createCommentToDB ( newId, userId, postId, comment) {
    return pool.query('INSERT INTO comments (comment_id, user_id, post_id, likes, comment_description) VALUES ($1, $2, $3, $4, $5) RETURNING *', [ newId, userId, postId, 0, comment])
  }
}
